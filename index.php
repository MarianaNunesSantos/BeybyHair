...
try {
  ...
  $stmt = $pdo->query("SELECT * FROM produto ORDER BY marcaPro, nomePro");
  ...
  foreach ($produtos as $produto) {
    ...
    $produtosPorMarca[$marca][] = $produto;
  }
} catch (PDOException $e) {
  die("Erro ao buscar produtos: " . $e->getMessage());
}

function exibirProdutosPorMarca($marca, $produtosDaMarca)
{
  echo '<div class="div-produtos row g-3">';

  foreach ($produtosDaMarca as $produto) {
    ...
    <div class="col-md-3 col-6">
      <div class="card h-100">
        <img class="card-img-top" src="' . htmlspecialchars($produto['imgPro']) . '" alt="' . htmlspecialchars($produto['nomePro']) . '">
        <div class="card-body">
...
<head>
  ...
  <title>Página Inicial - BeybyHair</title>
</head>
...
<body>
  ...
  <section class="section-body-carrosel">
  ...
  <main class="col-md-12">
    ...
    <section class="col-md-8 col-12">
      <br>
      <section class="section-carrosel-marcas">
        <h2><strong>Nossa Marcas</strong></h2>
        <br>
      ...
      <?php
      if (isset($produtosPorMarca['BAUNY'])) {
        exibirProdutosPorMarca('BAUNY', $produtosPorMarca['BAUNY']);
      }
      ?>
      ...
      <?php
      if (isset($produtosPorMarca['BRUNA TAVARES'])) {
        exibirProdutosPorMarca('BRUNA TAVARES', $produtosPorMarca['BRUNA TAVARES']);
      }
      ?>
      ...
      <?php
      if (isset($produtosPorMarca['OLLIE'])) {
        exibirProdutosPorMarca('OLLIE', $produtosPorMarca['OLLIE']);
      }
      ?>
    </section>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3">
          <h5>Redes Sociais</h5>
          <ul class="list-unstyled">
            <li class="li-footer"> <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
