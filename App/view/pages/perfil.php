...
$res = usuarioController::resgatarPorID($_SESSION['id']);
$op = "Alterar";
$qtd = $res->rowCount();
$row = $res->fetch(PDO::FETCH_OBJ);
$nome = $row->nomeUsu;
$sobrenome = $row->sobrenomeUsu;
$cpf = $row->cpfUsu;
$email = $row->emailUsu;
$senha = $row->senhaUsu;
$nascimento = $row->nascimentoUsu;
$telefone = $row->telefoneUsu;
$cep = $row->cepUsu;
$endereco = $row->enderecoUsu;
$numero = $row->numeroUsu;
$cep2 = $row->cep2Usu;
$endereco2 = $row->endereco2Usu;
$numero2 = $row->numero2Usu;
$cep3 = $row->cep3Usu;
$endereco3 = $row->endereco3Usu;
$numero3 = $row->numero3Usu;
$idUsuario = $row->idUsu;
...
<head>
    ...
    <link rel="stylesheet" href="../styles/perfil.css" defer>
...
<body>
                    ...
                    <div class="col-md-5 col-12 text-end nav-icons">
                        <?php if (isset($_SESSION['id'])): ?>
                            ...
                            <button class="btn-minha-conta"
                                ...
                                <a href="perfil.php" class="btn btn-link"><img src="../img/icon-user-marrom.png"
    ...
    <main class="col-md-12">
        ...
        <div class="container light-style flex-grow-1 container-p-y">
            <h1 class="font-weight-bold py-3 mb-4">Meus dados</h1>
                ...
                <div class="row no-gutters row-bordered row-border-light">
                    ...
                    <div class="col-md-3 pt-0">
                        <div class="list-group list-group-flush account-settings-links">
                            <a class="list-group-item list-group-item-action active" data-toggle="list"
                                href="#conta-cadastro"><i class="bi bi-person-circle"></i> Meu Cadastro</a>
                            <a class="list-group-item list-group-item-action" data-toggle="list"
                                href="#conta-pedidos"><i class="bi bi-box2-heart-fill"></i> Meus Pedidos</a>
                            <a class="list-group-item list-group-item-action" data-toggle="list"
                                href="#conta-agendamentos"><i class="bi bi-calendar-heart"></i>Meus Agendamentos</a>
                            <a class="list-group-item list-group-item-action" data-toggle="list" href="#conta-cartao"><i
                                    class="bi bi-gift"></i>Cartão Presente</a>
                            <a class="list-group-item list-group-item-action" data-toggle="list"
                                href="#conta-endereco"><i class="bi bi-geo-alt"></i>Meus Endereços</a>
                            <a class="list-group-item list-group-item-action" data-toggle="list" href="#conta-senha"><i
                                    class="bi bi-key"></i>Alterar Senha</a>
                            <a class="list-group-item list-group-item-action" data-toggle="list" href="#conta-sair"><i
                                    class="bi bi-key"></i>Sair</a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            <!-- Meu Cadastro -->
                            <div class="tab-pane fade active show" id="conta-cadastro">
                                <div class="card-body media align-items-center">
                                    <button class="vincular-conta-google">
                                        <img src="../img/logo-google.png" alt="logo google" class="icon-google">Vincular
                                        conta Google
                                    </button>
                                </div>
                                <div class="card-body">
                                    <form method='post' action='../../controller/processaUsuario.php'>
                                        <div class="form-grup">
                                        ...
                                        <!-- Estes são os campos que não vão ser alterados nessa aba-->
                                        <input type='hidden' name='senha' value="<?php echo $senha; ?>">
                                        <input type='hidden' name='cep' value="<?php echo $cep; ?>">
                                        <input type='hidden' name='endereco' value="<?php echo $endereco; ?>">
                                        <input type='hidden' name='numero' value="<?php echo $numero; ?>">
                                        <input type='hidden' name='cep2' value="<?php echo $cep2; ?>">
                                        <input type='hidden' name='endereco2' value="<?php echo $endereco2; ?>">
                                        <input type='hidden' name='numero2' value="<?php echo $numero2; ?>">
                                        <input type='hidden' name='cep3' value="<?php echo $cep3; ?>">
                                        <input type='hidden' name='endereco3' value="<?php echo $endereco3; ?>">
                                        <input type='hidden' name='numero3' value="<?php echo $numero3; ?>">
                                        <input type='hidden' name='idUsuario' value="<?php echo $idUsuario; ?>">
                                        <!---->

                                        <div class="form-grup" id="checkbox">
                                            <input type="checkbox">
                                            <p>Desejo receber promoções, novidades e informações da BeybyHair</p>
                                        </div>
                                        <div class="form-grup" id="checkbox">
                                            <input type="checkbox">
                                            <p>Quero receber informações do meu pedido por SMS.</p>
                                        </div>
                                        <div class="form-grup" id="checkbox">
                                            <input type="checkbox">
                                            <p>Quero receber notificações pelo WhatsApp</p>
                                        </div>
                            ...
                            <!-- Meus Pedidos -->
                            <div class="tab-pane fade" id="conta-pedidos">
                                <div class="form-grup" id="meus-pedidos-agendamentos">
                                    <img src="../img/pedidos-compras.jpg" class="img-pedidos"
                                        alt="avião de papel com compras">
                            ...
                            <!-- Meus Agendamentos -->
                            <div class="tab-pane fade" id="conta-agendamentos">
                                <div class="form-grup" id="meus-pedidos-agendamentos">
                                    <img src="../img/mulher-spa.jpg" class="img-spa" alt="moça no spa">
                                    <h3>Você ainda não possui agendamentos.</h3>
                                    <h3>Faça seu primeiro agendamento :)</h3>
                                </div>
                            </div>

                            <!-- Cartão Presente -->
                            <div class="tab-pane fade" id="conta-cartao">
                                <div class="form-grup" id="meus-pedidos-agendamentos">
                                    <img src="../img/mulher-presente.jpg" class="img-presente"
                                        alt="moça com presente na mão">
                                </div>
                                <div class="form-grup">
                            ...
                            <!-- Meus Endereços -->
                            <div class="tab-pane fade" id="conta-endereco">
                                <form method='post' action='../../controller/processaUsuario.php'>
                                    <div class="form-grup">
                                        <h3>Meus Endereços</h3>
                                        <button class="button-salvar" id="btnNovoEndereco">NOVO ENDEREÇO</button>
                                    </div>
                                    <hr>
                                    <div>
                                        <?php
                                        // Parseia o endereço para obter as partes separadas
                                        $enderecoParseado = parseEndereco($endereco);
                                        ?>
                                        <table>
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Endereço Padrão</td>
                                                    <td><input type="text" name="cep" id="cep"
                                                            class="input-endereco cep-input"
                                                            value="<?php echo $cep; ?>"></td>
                                                    <td id="logradouro">
                                                        <?php echo htmlspecialchars($enderecoParseado['logradouro']); ?>
                                                    </td>
                                                    <td><input type="text" name="numero" id="numero"
                                                            class="input-endereco" value="<?php echo $numero; ?>"></td>
                                                    <td id="bairro">
                                                        <?php echo htmlspecialchars($enderecoParseado['bairro']); ?>
                                                    </td>
                                                    <td id="cidade">
                                                        <?php echo htmlspecialchars($enderecoParseado['cidade']); ?>
                                                    </td>
                                                    <td id="uf"><?php echo htmlspecialchars($enderecoParseado['uf']); ?>
                                                    </td>
                                                </tr>
                                                <!-- <tr>
                                                    <td>Endereço Secundário</td>
                                                    <td>CEP do segundo endereço</td>
                                                    <td>Logradouro do segundo endereço</td>
                                                    <td>Número do segundo endereço</td>
                                                    <td>Bairro do segundo endereço</td>
                                                    <td>Cidade do segundo endereço</td>
                                                    <td>Estado do segundo endereço</td>
                                                </tr>
                                                <tr>
                                                    <td>Endereço Terciário</td>
                                                    <td>CEP do terceiro endereço</td>
                                                    <td>Logradouro do terceiro endereço</td>
                                                    <td>Número do terceiro endereço</td>
                                                    <td>Bairro do terceiro endereço</td>
                                                    <td>Cidade do terceiro endereço</td>
                                                    <td>Estado do terceiro endereço</td>
                                                </tr> -->
                                            </tbody>
                                        </table>
                                    </div>

                                    <!-- Campos hidden para o endereço completo -->
                                    <input type="hidden" name="endereco" id="enderecoCompleto"
                                        value="<?php echo htmlspecialchars($endereco); ?>">

                                    <!-- Campos para outros dados do usuário (mantidos hidden) -->
                                    ...
                                    <input type='hidden' name='cep2'
                                        value="<?php echo isset($cep2) ? htmlspecialchars($cep2) : ''; ?>">
                                    <input type='hidden' name='endereco2'
                                        value="<?php echo isset($endereco2) ? htmlspecialchars($endereco2) : ''; ?>">
                                    <input type='hidden' name='numero2'
                                        value="<?php echo isset($numero2) ? htmlspecialchars($numero2) : ''; ?>">
                                    <input type='hidden' name='cep3'
                                        value="<?php echo isset($cep3) ? htmlspecialchars($cep3) : ''; ?>">
                                    <input type='hidden' name='endereco3'
                                        value="<?php echo isset($endereco3) ? htmlspecialchars($endereco3) : ''; ?>">
                                    <input type='hidden' name='numero3'
                                        value="<?php echo isset($numero3) ? htmlspecialchars($numero3) : ''; ?>">
                                    <input type='hidden' name='idUsuario' value="<?php echo $idUsuario; ?>">
                                    <input type='hidden' name='op' value="<?php echo $op; ?>">

                                    <button type="submit" class="button-salvar">ALTERAR ENDEREÇO</button>
                                </form>
                            </div>

                            <!-- Alterar Senha -->
                            <div class="tab-pane fade" id="conta-senha">
                                <div class="form-grup">
                                ...
                                <form method='post' action='../../controller/processaUsuario.php'>
                                    <div class="form-grup">
                                        <label class="form-label">* Confirme sua senha atual:</label>
                            ...
                            <!-- Sair -->
                            <div class="tab-pane fade" id="conta-sair">
                                <h3>Deseja sair da sua conta?</h3>
                                <button class="button-sair"><a href="logout.php">SAIR</a></button>
                                <br>
                                <br>
                                <br>
                                <hr>
                                <br>
                                <br>
                                <h3>Ou... deseja deletar sua conta? :(</h3>
                                <button class="button-sair"
                                    onclick="if(confirm('Tem certeza que deseja excluir sua conta?')) { window.location.href='../../controller/processaUsuario.php?op=Excluir&idUsuario=<?php echo $_SESSION['id']; ?>' }">DELETAR
                                    CONTA
                                </button>
                            </div>
                        </div>
