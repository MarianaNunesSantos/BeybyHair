...
$nomeBanner = strtolower(iconv('UTF-8', 'ASCII//TRANSLIT', $categoria));
$nomeBanner = preg_replace('/[^a-z0-9]/', '-', $nomeBanner);
$caminhoBanner = "../img/{$nomeBanner}.png";

$mapeamentoBanners = [
    'COLORAÇÕES' => 'coloracoes.png',
    'MÃOS E PÉS' => 'maos e pes.png',
    'ELÉTRICOS' => 'eletricos.png',
    'ACESSÓRIOS' => 'acessorios.png',
];

$nomeBanner = $mapeamentoBanners[$categoria] ?? strtolower(str_replace(' ', '-', $categoria)) . '.png';
$caminhoBanner = "../img/{$nomeBanner}";

if (!file_exists($caminhoBanner)) {
    $caminhoBanner = "../img/banner-padrao.png";
}

// Verifica se o banner existe, senão usa um padrão
if (!file_exists($caminhoBanner)) {
    $caminhoBanner = "../img/banner-padrao.png";
}
?>
...
<head>
    ...
    <!-- Link para o CSS do Bootstrap -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <title><?= htmlspecialchars($categoria) ?> - BeybyHair</title>
</head>
...
<body>
            ...
            <div class="col text-center">
                <ul>
                    ...
                    <div class="menu-lateral" id="menu-lateral">
                        ...
                        <ul>
                            <li><a href="categoria.php?categoria=COLORAÇÕES" data-submenu="coloracoes">COLORAÇÕES</a>
                            </li>
                            <li><a href="categoria.php?categoria=MAQUIAGEM" data-submenu="maquiagem">MAQUIAGEM</a></li>
                            <li><a href="categoria.php?categoria=MÃOS E PÉS" data-submenu="maos-e-pes">MÃOS E PÉS</a>
                            </li>
                            <li><a href="categoria.php?categoria=CABELOS" data-submenu="cabelos">CABELOS</a></li>
                            <li><a href="categoria.php?categoria=HIGIENE PESSOAL" data-submenu="higiene">HIGIENE
                                    PESSOAL</a></li>
                            <li><a href="categoria.php?categoria=SKINCARE" data-submenu="skincare">SKINCARE</a></li>
                            <li><a href="categoria.php?categoria=DEPILAÇÃO" data-submenu="depilacao">DEPILAÇÃO</a></li>
                            <li><a href="categoria.php?categoria=ELÉTRICOS" data-submenu="eletricos">ELÉTRICOS</a></li>
                            <li><a href="categoria.php?categoria=ACESSÓRIOS" data-submenu="acessorios">ACESSÓRIOS</a>
                            </li>
                            <li><a href="categoria.php?categoria=HOMENS" data-submenu="homens">HOMENS</a></li>
                        </ul>
                    </div>
    ...
    <main class="col-md-12 container-fluid d-flex justify-content-center">
        <section class="col-md-2 col-0"></section>

        <section class="col-md-8 col-12">
            <!-- Banner da categoria -->
            <img src="<?= $caminhoBanner ?>" alt="<?= htmlspecialchars($categoria) ?>"
                class="img-fluid mb-4 banner-categoria">

            <h1 class="mb-4 titulo"><?= htmlspecialchars($categoria) ?></h1>
            <hr>

            <!-- Produtos de acordo com a categoria clicada -->
            <?php if (count($produtos) > 0): ?>
                <div class="div-produtos row g-3">
                    <?php foreach ($produtos as $produto):
                        $precoParcela = number_format($produto['valorPro'] / 2, 2, ',', '.');
                        $preco = number_format($produto['valorPro'], 2, ',', '.');
                        $imgProduto = str_replace('view/', '../', $produto['imgPro']);
                        ?>
                        <div class="col-md-3 col-6">
                            <div class="card h-100">
                                <div class="position-relative">
                                    <a href="produto.php?id=<?= $produto['idPro'] ?>">
                                        <img class="card-img-top" src="<?= htmlspecialchars($imgProduto) ?>"
                                            alt="<?= htmlspecialchars($produto['nomePro']) ?>">
                                    </a>
                                </div>
                                <div class="card-body">
                                    ...
                                    <a href="produto.php?id=<?= $produto['idPro'] ?>" class="btn btn-primary">VER PRODUTO</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
