...
try {
    // Busca os produtos favoritados pelo usuário
    $stmt = $pdo->prepare("
        SELECT p.* 
        FROM produto p
    ...
    die("Erro ao buscar favoritos: " . $e->getMessage());
}
?>
...
<head>
    ...
    <!-- Link para o CSS do Bootstrap -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <title>Wishlist - BeybyHair</title>
</head>
...
<body>
                    ...
                    <div class="col-md-5 col-12 text-end nav-icons">
                        ...
                        <?php if (isset($_SESSION['id'])): ?>
                            ...
                            <a href="favoritos.php" class="btn btn-link">
                                <img src="../img/icon-favoritado.png" alt="Ícone de coração cheio">Favoritos
                            </a>
                        <?php else: ?>
                            <!-- Botão quando NÃO LOGADO -->
    ...
    <main class="col-md-12 container-fluid d-flex justify-content-center">
        ...
        <section class="col-md-8 col-12">
            <h1 class="mb-4 titulo"><img src="../img/icon-favoritado.png" alt=""> WISHLIST</h1>
            <hr>

            <?php if (count($produtosFavoritos) > 0): ?>
            ...
            <?php else: ?>
                <img class="sem-favoritos" src="../img/sem-favoritos.png" alt="">
            <?php endif; ?>
        </section>
