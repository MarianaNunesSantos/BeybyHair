...
// Inicializa o carrinho vazio se não existir
...
<head>
    ...
    <!-- Link para o CSS do Bootstrap -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <title>Minha Sacola - BeybyHair</title>
</head>
...
<body>
    ...
    <main class="col-md-12 container-fluid">
        ...
        <section class="col-md-8 col-12 section-carrinho">
            <div class="d-flex row justify-content-center div-carrinho">
                <h1 class="mb-4">Minha Sacola</h1>

                <?php if (isset($_SESSION['id']) && empty($carrinho)): ?>
                ...
                <?php else: ?>
                    ...
                    <div class="row carrinho">
                        <div class="col-md-8 tabela-produtos">
                            <div class="table-responsive">
                                <table class="table" id="teste-tabela">
                                    <thead>
                                        <tr>
                                            <th>PRODUTO</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($carrinho as $item): ?>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center imagem-produto">
                                                        <img src="<?= htmlspecialchars(str_replace('view/', '../', $item['imagem'])) ?>"
                                                            alt="<?= $item['nome'] ?>" width="80" class="me-3">
                                                    </div>
                                                </td>
                                                <td>
                                                    <h5><strong><?= $item['nome'] ?></strong></h5>
                                                    <small class="text-muted"><strong><?= $item['marca'] ?></strong></small><br>
                                                    <p class="descricao-produto"><?= $item['descricao'] ?></p>
                                                </td>
                                                <td>
                                                    <div class="input-group" style="width: 120px;">
                                                        <button class="btn btn-outline-secondary diminuir"
                                                            type="button">-</button>
                                                        <input type="number" class="form-control text-center quantidade"
                                                            value="<?= $item['quantidade'] ?>" min="1"
                                                            data-id="<?= $item['id'] ?>">
                                                        <button class="btn btn-outline-secondary aumentar"
                                                            type="button">+</button>
                                                    </div>
                                                </td>
                                                <td class="preco-item">R$
                                                    <?= number_format($item['valor'] * $item['quantidade'], 2, ',', '.') ?>
                                                </td>
                                                <td>
                                                    <button class="btn btn-danger btn-sm remover-item"
                                                        data-id="<?= $item['id'] ?>">
                                                        <img src="../img/icon-remover.png" alt="Ícone de remover">
                                                    </button>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <h6>Cupom</h6>
                                        <p class="text-end text-danger" id="cupom-desconto">- R$ 0,00</p>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-4 total-pedido">
                                        ...
                                        <h4 id="total-pedido">R$ <?= number_format($total, 2, ',', '.') ?></h4>
                                    </div>
