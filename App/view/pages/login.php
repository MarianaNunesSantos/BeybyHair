...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($usuario && password_verify($senha, $usuario['senhaUsu'])) {
        ...
        $_SESSION['sobrenome'] = $usuario['sobrenomeUsu'];
        $_SESSION['email'] = $usuario['emailUsu'];
...
<head>
    ...
    <!-- Link para o CSS do Bootstrap -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <title>Entre ou cadastre-se - BeybyHair</title>
</head>
...
<body>
    ...
    <main class="col-md-12">
        ...
        <section class="col-md-8 col-12 section-corpo-login">

            <div class="div-linha-entre-as-divis-login d-flex flex-wrap">
                <div class="col-md-5 col-12 order-1 order-md-1 div-cliente-login">
                    <form method="POST">
                        ...
                        <button type="submit" id="botao-submit-login" name="Login.Submit"
                            class="button-produto"><a>Entrar</a></button>
                ...
                <hr class="col-0 order-md-2 hr-login" />

                <h3 class="col-12 d-block d-md-none order-2 div-ou-mobile">ou</h3>

                <div class="col-md-5 col-12 order-3 order-md-3 div-cadastro">
                    <form class="w-100" action="cadastro.php" method="GET">
                        <h2>Quero criar uma conta</h2>
                        <label>NOME</label>
                        <input type="text" name="nomeCadastro" placeholder="Nome">
                        <label>SOBRENOME</label>
                        <input type="text" name="sobrenomeCadastro" placeholder="Sobrenome">
                        <label>E-MAIL</label>
                        <input type="email" name="emailCadastro" placeholder="E-mail">
                        <label>SENHA</label>
                        <input type="password" name="senhaCadastro" placeholder="Senha">
                        <button type="submit" id="botao-submit-cadastro" name="Cadastro.Submit"
                            class="button-produto"><a>Criar conta</a></button>
                    </form>
                </div>
            </div>

            <h3 class="col-12 d-block d-md-none div-ou-mobile">ou</h3>

            <div class="d-none d-sm-block div-ou">
                <p>ou</p>
            </div>

            <hr class="d-none d-sm-block hr-login-baixo">

            <div class="col-md-4 col-12 div-login-externo">
                <button class="button-conta-google"><span><img src="../img/logo-google.png">
                        <h5>Entre ou crie uma conta usando o Google</h5>
                    </span></button>
            </div>
